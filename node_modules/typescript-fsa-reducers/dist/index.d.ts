...
export interface ReducerBuilder<InS extends OutS, OutS = InS> {
    ...
    cases<P>(actionCreators: Array<ActionCreator<P>>, handler: Handler<InS, OutS, P>): ReducerBuilder<InS, OutS>;
    ...
    casesWithAction<P>(actionCreators: Array<ActionCreator<P>>, handler: Handler<InS, OutS, Action<P>>): ReducerBuilder<InS, OutS>;
    withHandling(updateBuilder: (builder: ReducerBuilder<InS, OutS>) => ReducerBuilder<InS, OutS>): ReducerBuilder<InS, OutS>;
    default(defaultHandler: Handler<InS, OutS, AnyAction>): (state: InS | undefined, action: {
        type: any;
    }) => OutS;
...
export declare function reducerWithoutInitialState<S>(): ReducerBuilder<S>;
